...
export default function ProductReceive({ }: Props) {
    ...
    const loadTransactionList = async () => {
        ...
        axios
            .get(
                `${API_URL}/${ApiServicePath.Transaction}/basic-list?transactionTypeId=${TransactionType.PRODUCT_RECEIVE}&pageNo=${pageNo}`
            )
            .then((response) => {
            ...
            if (formState === TransactionFormState.CREATE) {
                axios
                    .post(`${API_URL}/${ApiServicePath.Transaction}`, {
                        ...
                        transactionTypeId: TransactionType.PRODUCT_RECEIVE,
                        description: transactionForm.getFieldValue("description"),
                        supplierId: transactionForm.getFieldValue("supplierId"),
